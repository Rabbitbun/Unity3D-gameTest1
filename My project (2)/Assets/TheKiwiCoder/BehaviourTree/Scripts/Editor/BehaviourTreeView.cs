...
namespace TheKiwiCoder {
    public class BehaviourTreeView : GraphView {
        ...
        public ScriptTemplate[] scriptFileAssets = {
            ...
            new ScriptTemplate{ templateFile=BehaviourTreeSettings.GetOrCreateSettings().scriptTemplateDecoratorNode, defaultFileName="NewConditionNode.cs", subFolder="Conditions" },
            new ScriptTemplate{ templateFile=BehaviourTreeSettings.GetOrCreateSettings().scriptTemplateDecoratorNode, defaultFileName="NewServiceNode.cs", subFolder="Services" },
        };
        ...
        public override void BuildContextualMenu(ContextualMenuPopulateEvent evt) {
            ...
            evt.menu.AppendAction($"Create Script.../New Service Node", (a) => CreateNewScript(scriptFileAssets[4]));
...

            {
                ...
                foreach (var type in types)
                {
                    evt.menu.AppendAction($"[Service]/{type.Name}", (a) => CreateNode(type, nodePosition));
                }
            }
        }
